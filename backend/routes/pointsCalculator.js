...
router.route("/updateForRupee").patch((req, res) => {
  PointsCalculator.findOne()
    .then((item) => {
...
router.route("/updateGivenPoints").patch((req, res) => {
  PointsCalculator.findOne()
    .then((item) => {
...
router.route("/updateForPoints").patch((req, res) => {
  PointsCalculator.findOne()
    .then((item) => {
...
router.route("/updateGivenDiscount").patch((req, res) => {
  PointsCalculator.findOne()
    .then((item) => {
